...
public sealed class PublicSiteSeeds : ILocalizationSeedSource
{
    ...
    public IEnumerable<TranslationSeed> Translations() => SeedBuilder.Bilingual(En, Hi, new[]
    {
        ...
        ("blog", "nav.breadcrumb", "Breadcrumb", "ब्रेडक्रम्ब"),
        ...
        ("blog", "content.loadFailed", "Failed to load this page. Please try again.",
            "यह पृष्ठ लोड नहीं हो सका। कृपया पुनः प्रयास करें।"),
        ("blog", "content.words", "{count} words", "{count} शब्द"),
        ("blog", "content.views", "{count} views", "{count} बार देखा गया"),
        ("blog", "content.contents", "Contents", "विषय-सूची"),
        ("blog", "content.backToTop", "Back to top", "ऊपर जाएँ"),
        ("blog", "content.print", "Print", "प्रिंट करें"),
        ("blog", "content.copyCode", "Copy code", "कोड कॉपी करें"),
        ("blog", "content.copy", "Copy", "कॉपी"),
        ("blog", "content.copied", "Copied!", "कॉपी हो गया!"),
        ("blog", "content.copyFailed", "Failed", "विफल"),
        ("blog", "tree.files", "{count} files", "{count} फ़ाइलें"),

        // ---- Blog: tag index ----
        ("blog", "tags.title", "Tags", "टैग"),
        ("blog", "tags.subtitle",
            "Browse the library by topic. Tags come from each document; a document with none is filed under its folder.",
            "विषय के अनुसार लाइब्रेरी देखें। टैग प्रत्येक दस्तावेज़ से आते हैं; जिनमें कोई नहीं, वे अपने फ़ोल्डर के अंतर्गत आते हैं।"),
        ("blog", "tags.all", "All", "सभी"),
        ("blog", "tags.noMatches", "No documents carry this tag.", "इस टैग वाला कोई दस्तावेज़ नहीं है।"),

        // ---- Blog: comments. There is no anonymous posting, so the signed-out copy has to explain
        // that an account is requested and granted, not simply created. ----
        ("blog", "comments.title", "Comments", "टिप्पणियाँ"),
        ("blog", "comments.empty", "No comments yet. Be the first.", "अभी कोई टिप्पणी नहीं। पहले आप कहिए।"),
        ("blog", "comments.loadFailed", "Comments could not be loaded right now.",
            "टिप्पणियाँ अभी लोड नहीं हो सकीं।"),
        ("blog", "comments.post", "Post comment", "टिप्पणी भेजें"),
        ("blog", "comments.placeholder", "Share a correction, a question, or what you learned…",
            "कोई सुधार, प्रश्न, या आपने जो सीखा वह साझा करें…"),
        ("blog", "comments.postingAs", "Posting as {name}", "{name} के रूप में लिख रहे हैं"),
        ("blog", "comments.you", "you", "आप"),
        ("blog", "comments.edited", "edited", "संपादित"),
        ("blog", "comments.editLabel", "Edit your comment", "अपनी टिप्पणी संपादित करें"),
        ("blog", "comments.confirmDelete", "Delete this comment?", "यह टिप्पणी मिटाएँ?"),
        ("blog", "comments.signInPrompt", "Sign in to join the discussion.",
            "चर्चा में शामिल होने के लिए साइन इन करें।"),
        ("blog", "comments.signIn", "Sign in", "साइन इन"),
        ("blog", "comments.requestAccount", "Request an account", "खाता का अनुरोध करें"),
        ("blog", "comments.approvalNote",
            "Accounts are approved by hand, so there is a wait — and no anonymous comments.",
            "खाते हाथ से स्वीकृत होते हैं, इसलिए थोड़ा इंतज़ार लगेगा — और अनाम टिप्पणी संभव नहीं है।"),
        ("blog", "comments.errorSignedOut", "Your session has expired. Sign in and try again.",
            "आपका सत्र समाप्त हो गया। साइन इन करके पुनः प्रयास करें।"),
        ("blog", "comments.errorTooMany", "That is a lot of comments in a short time. Try again shortly.",
            "थोड़े समय में बहुत सारी टिप्पणियाँ। कुछ देर बाद प्रयास करें।"),
        ("blog", "comments.errorGeneric", "That did not go through. Please try again.",
            "यह भेजा नहीं जा सका। कृपया पुनः प्रयास करें।"),
