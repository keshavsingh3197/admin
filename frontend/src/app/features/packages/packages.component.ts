...
@Component({
    ...
    <div class="wrap">
      <header class="head">
        <div>
          ...
          <p>Private package releases and every repo that consumes them, read live from GitHub.</p>
        </div>
  ...
  `,
  styles: [`
    .wrap{max-width:1200px;margin:0 auto;padding:1rem}.head{display:flex;align-items:center;justify-content:space-between;gap:1rem;margin-bottom:1rem}.head h1{margin:0;font-size:1.5rem;color:var(--text)}.head p{margin:.2rem 0 0;color:var(--muted);font-size:.9rem}.refresh{border:1px solid var(--border);border-radius:6px;background:var(--surface);color:var(--text);padding:.5rem .85rem;cursor:pointer}.refresh:disabled{opacity:.55}.banner{border:1px solid color-mix(in srgb,var(--danger-border) 35%,var(--border));background:color-mix(in srgb,var(--danger) 9%,var(--surface));color:var(--text);padding:.75rem;border-radius:6px;margin-bottom:1rem}.banner a{color:inherit;font-weight:600}.diagnostics{list-style:none;margin:0 0 1rem;padding:0;display:flex;flex-direction:column;gap:.4rem}.diagnostics li{border:1px solid color-mix(in srgb,var(--warning-border) 35%,var(--border));background:color-mix(in srgb,var(--warning) 8%,var(--surface));color:var(--text);padding:.5rem .75rem;border-radius:6px;font-size:.85rem}.loading{display:flex;justify-content:center;align-items:center;gap:.6rem;padding:2rem;color:var(--muted)}.spinner{width:18px;height:18px;border:2px solid var(--border);border-top-color:var(--brand);border-radius:50%;animation:spin .7s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}.summary{display:grid;grid-template-columns:repeat(4,minmax(100px,1fr));border-block:1px solid var(--border);margin-bottom:1rem}.summary div{display:flex;flex-direction:column;padding:.8rem 1rem;border-right:1px solid var(--border)}.summary div:last-of-type{border-right:0}.summary strong{font-size:1.25rem;color:var(--text)}.summary span,.summary small{font-size:.78rem;color:var(--muted)}.summary .attention strong{color:var(--warning)}.summary small{grid-column:1/-1;padding:.45rem 1rem;border-top:1px solid var(--border)}.filters{display:grid;grid-template-columns:2fr repeat(3,1fr);gap:.65rem;margin-bottom:.8rem}.filters label{display:flex;flex-direction:column;gap:.25rem;color:var(--muted);font-size:.75rem}.filters input,.filters select{min-width:0;padding:.45rem .55rem;border:1px solid var(--border);border-radius:5px;background:var(--bg);color:var(--text)}.table-shell{overflow:auto;border:1px solid var(--border);border-radius:7px;transition:opacity .15s}.table-shell.refreshing{opacity:.55}table{width:100%;border-collapse:collapse;min-width:850px}th{text-align:left;font-size:.72rem;text-transform:uppercase;color:var(--muted);background:var(--surface);padding:.65rem;border-bottom:1px solid var(--border)}td{padding:.7rem .65rem;border-bottom:1px solid var(--border);vertical-align:top;color:var(--text);font-size:.84rem}tbody tr:last-child td{border-bottom:0}td:first-child strong,td:first-child small{display:block}.ecosystem{display:inline-block;margin-bottom:.25rem;text-transform:uppercase;font-size:.62rem;font-weight:700;color:var(--brand)}td:first-child small{color:var(--muted);margin-top:.2rem}code{font-size:.78rem;color:var(--text)}.status{display:inline-block;padding:.2rem .45rem;border-radius:4px;font-size:.7rem;font-weight:700}.status.current{background:var(--success-soft);color:var(--success)}.status.publish-required{background:var(--warning-soft);color:var(--warning)}.status.upgrade-required{background:var(--danger-soft);color:var(--danger)}.consumer{display:flex;justify-content:space-between;gap:1rem;padding:.18rem 0;color:var(--muted);font-size:.75rem}.consumer.drift{color:var(--danger)}.muted,.empty{color:var(--muted)}.empty{text-align:center;padding:1rem}@media(max-width:760px){.head{align-items:flex-start}.summary{grid-template-columns:repeat(2,1fr)}.summary div:nth-child(2){border-right:0}.filters{grid-template-columns:1fr 1fr}.filters label:first-child{grid-column:1/-1}}@media(max-width:480px){.wrap{padding:.75rem}.head{flex-direction:column}.filters{grid-template-columns:1fr}.filters label:first-child{grid-column:auto}}
  `]
})
